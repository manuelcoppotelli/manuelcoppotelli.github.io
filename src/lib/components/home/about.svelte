...
<section id="about">
	<div class="info">
		<h2>
			I'm a <SparklingHighlight>Professional Mistake Avoider</SparklingHighlight>, a.k.a. Strategic
			Advisor.
		</h2>
		<p>
			I am an advocate for other people's success, pushing boundaries, and open-source software.
			Passionate about community, culture and learning new things.
		</p>
	</div>
	<div class="avatar">
